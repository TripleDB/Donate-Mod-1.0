...
Func applyConfig($bRedrawAtExit = True, $TypeReadSave = "Read") ;Applies the data from config to the controls in GUI
	...
	; <><><><> Village / Endzy Mod <><><><>
	ApplyConfig_600_7($TypeReadSave) ; Endzy Mod
...
Func ApplyConfig_600_7($TypeReadSave) ; Endzy Mod
	; <><><><> Village / Endzy Mod <><><><>
	Switch $TypeReadSave
		Case "Read"
			GUICtrlSetState($g_hChkRequestOnly, $g_bChkRequestOnly ? $GUI_CHECKED : $GUI_UNCHECKED)
			GUICtrlSetState($g_hChkDonateOnly, $g_bChkDonateOnly ? $GUI_CHECKED : $GUI_UNCHECKED) ; Endzy Mod
