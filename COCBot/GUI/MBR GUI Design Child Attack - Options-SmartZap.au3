...
Func CreateAttackNewSmartZap()
	...
	$y += 50
		...
		$g_hInpSmartZapTimes = _GUICtrlCreateInput("90", $x + 120, $y + 140, 40, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	$g_hTxtSmartZapMinDE = _GUICtrlCreateInput("350", $x + 289, $y + 32, 90, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))			_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Options-SmartZap", "LblSmartZap_Info_01", "Set the Value of the minimum amount of Dark Elixir in the Drills"))
			GUICtrlSetLimit(-1, 3)
